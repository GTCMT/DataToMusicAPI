...
var alias = {
    ...
    notenum: ['notenumber', 'notenum', 'nn', 'n'],
...
dtm.synth = function () {
    ...
    synth.t = synth.tr = synth.trig = synth.trigger = synth.onnote;
    ...
    synth.amplitude.add = function () {
        mapParam(arguments, params.amp, 'add');
        return synth;
    };

    synth.amplitude.mult = function () {
    ...
    ['play', 'stop', 'interval', 'duration', 'repeat', 'amplitude', 'frequency', 'notenum', 'pitch'].forEach(function (name) {
        if (name in alias) {
