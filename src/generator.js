 ...
 */
dtm.g = dtm.gen = dtm.generator = function () {
    var paramsExt = {
        type: null,
        min: 0.0,
        max: 1.0,
    ...
    return generator.set.apply(generator, arguments);
    // return generator;
};
...
Generator.prototype = Object.create(Data.prototype);
Generator.prototype.constructor = Generator;

// dtm.generator.augment = function (fnList) {
//
// };
